...
public int overallScore()
{
   ...
   if (score1 < score2 && score1 < score3) {
      ...
      s1 = score1;
      s2 = score3;//Changed this from score2 to score3 because if score2 is the minimum value it shouldn't be counted.
   } else{ //The else if check here was unnecessary and was cut from the program
      s1 = score1;
      s2 = score2;
   }
   s = s1 + s2;
